...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/');?>slick/slick.css?v=<?php echo PROJE_VERSION; ?>"/>

 <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/');?>slick/slick-theme.css?v=<?php echo PROJE_VERSION; ?>"/>
 ...
 <link href="<?= base_url('assets/datatables/css/bootstrap-table.min.css') ?>" rel="stylesheet" type="text/css"/>	
        		...
        		<aside class="main-sidebar">
        			...
        			<div class="sidebar">
        				...
        				<div class="user-panel text-center">
        					...
        					<script type="text/javascript">
        						$(document).ready(function () {
                                    ...
                                    else if (segment_2 === 'wallets' ) {
                                        $('.wallets').addClass('active');
                                    }
                                    else if (segment_2 === 'prediction' ) {
                           ...
                           <li class="wallets">
                            <a href="<?php echo base_url('customer/wallets') ?>"><i class="fa fa-gavel" style="color: red"></i> <?php echo display('wallets') ?></a>
                        </li>
                        <li class="prediction">
                            <a href="<?php echo base_url('customer/prediction') ?>"><i class="fa fa-gavel" style="color: red"></i> <?php echo display('prediction') ?></a>
                        </li>
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li><a href="<?php echo base_url('customer/t') ?>"><?php echo display('uye_listesi') ?></a></li>
...
<script src="<?php echo base_url('assets/js');?>/build/jquery.datetimepicker.full.min.js"></script>
...
<script src="<?php echo base_url("assets/datatables/js/bootstrap-table.min.js") ?>"></script>
<script src="<?php echo base_url("assets/datatables/js/bootstrap-table-locale-all.min.js") ?>"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/');?>slick/slick.min.js"></script>
		...
		<!-- Start Page Lavel Plugins
            ...
            <script src="<?php echo base_url() ?>assets/js/custom.js?v=<?php echo PROJE_VERSION; ?>" type="text/javascript"></script>
