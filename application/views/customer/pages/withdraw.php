...
<?php if ($block=='no'){ ?>
	...
	<!--		    <div class="radio radio-info radio-inline">
                                    ...
                                    <div class="radio radio-inline">
                                        <input type="radio" id="inlineRadio2" value="2" name="varify_media" checked="checked">
...
<?php }else {  $this->session->set_flashdata('exception', 'You can not dublicate withdraw before '.$bday.' days. ');
