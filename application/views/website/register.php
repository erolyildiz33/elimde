...
<head>
    ...
    <!-- Main css -->
    <link rel="stylesheet" href="<?php echo base_url("assets/website/login/"); ?>css/style.css">
    <style>
...
<body>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title"><?php echo display('register'); ?></h2>
                        <?php echo form_open('register','id="registerForm" name="registerForm" onsubmit="return validateForm()" '); ?>

                        <div class="form-group">
                            <label for="sponsor_id"><i class="zmdi zmdi-accounts-alt"></i></label>
                            <input type="text" name="sponsor_id" id="sponsor_id" value="<?php if(isset($_GET['ref'])) {echo $_GET['ref'];} ?>" placeholder="<?php echo display('sponsor_id'); ?>"  required/>
                        </div>
                        <div class="form-group">
                            <label for="username"><i class="zmdi zmdi-star-circle"></i></label>
                            <input type="text" name="username" id="username" placeholder="<?php echo display('username'); ?>"   required/>
                        </div>

                        <div class="form-group">
                            <label for="f_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" name="f_name" id="f_name"  placeholder="<?php echo display('firstname'); ?>"   required/>
                        </div>

                        <div class="form-group">
                            <label for="l_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            <input type="text" name="l_name" id="l_name"  placeholder="<?php echo display('lastname'); ?>"   required/>
                        </div>
    ...
    padding: 6px 30px;
    font-family: Poppins;
    box-sizing: border-b"  searchable="Search here.." id="country" name="country">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" id="phone"  placeholder="<?php echo display('zmdi-phone'); ?>"   required/>
                    </div>

                    <div class="form-group">
                        <label for="email"><i class="zmdi zmdi-email"></i></label>
                        <input type="email" type="email" id="email" name="email" id="email" onkeydown="checkEmail()" value="<?php echo $this->session->userData['email']; ?>" autocomplete="off" required placeholder="<?php echo display('email'); ?>"/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="pass" id="pass" onkeyup="strongPassword()" required placeholder="<?php echo display('password'); ?>"/>
                  ...
                  <div class="form-group">
                    <label for="r_pass"><i class="zmdi zmdi-lock-outline"></i></label>
                    <input type="password" name="r_pass" id="r_pass" onkeyup="rePassword()" required placeholder="<?php echo display('conf_password'); ?>" />
                </div>
                ...
                <div class="form-group form-button">
                    ...
                    <a href="<?php echo base_url('home/login'); ?>" class="signup-image-link">I am already member</a>
                </div>
                <?php echo form_close() ?>
            </div>
