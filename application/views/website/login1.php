...
<div class="reg-wrapper">
    <div class="container" style="background-color: #0088cc!important;">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="tab1">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input">
                                    <input class="input__field" type="text" name="sponsor_id" id="sponsor_id" required>
                                    <label class="input__label" for="sponsor_id">
                                        <span class="input__label-content" data-content="<?php echo display('sponsor_id'); ?>"><?php echo display('sponsor_id'); ?></span>
                                    </label>
                                </div>
                            </div>
