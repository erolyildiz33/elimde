...
<head>
    ...
    <link href="<?php echo base_url('assets/website/css/owl.carousel.min.css') ?>" rel="stylesheet" type="text/css"/>
    <!-- pe-icon-7-stroke -->
            ...
            <div class="sidebar">
                ...
                <div class="user-panel text-center">
                    ...
                    <ul class="sidebar-menu"> 
                        ...
                        <li>
                            <a  href="<?php echo base_url("home/block") ?>"><i class="fa fa-exclamation-triangle"></i><?php echo display('blockday') ?></a>
                        </li>
              <li>
			    <a  href="<?php echo base_url("home/adminNote") ?>"><i class="fa fa-sticky-note-o"style="color:red"></i><?php echo display('AdminNotemenu') ?></a>
                        </li>           
                    </ul>
                </div> <!-- /.sidebar -->
            </aside>
...
<script src="https://unpkg.com/bootstrap-table@1.15.5/dist/extensions/reorder-rows/bootstrap-table-reorder-rows.min.js"></script>
	...
	<!-- Table Head Fixer -->
        ...
        <script src="<?php echo base_url() ?>assets/js/custom1.js" type="text/javascript"></script>
    </body>
    </html>
