                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $value->amount; ?></td>
                                 ...
                                 <td>
                                     <a href="<?php echo base_url()?>backend/withdraw/withdraw/confirm_withdraw_main?id=<?php echo $value->withdraw_id;?>&user_id=<?php echo $value->user_id;?>" class="btn btn-warning btn-sm"><?php echo display('confirm')?></a>
                                     <a href="<?php echo base_url()?>backend/withdraw/withdraw/cancel_withdraw_main?id=<?php echo $value->withdraw_id;?>&user_id=<?php echo $value->user_id;?>" class="btn btn-danger btn-sm"><?php echo display('cancel')?></a>
