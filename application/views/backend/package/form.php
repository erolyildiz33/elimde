            ...
            <div class="panel-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7">
                    <div class="border_preview">
                        ...
                        <div class="form-group row">
                            <label for="p_type" class="col-sm-4 col-form-label"><?php echo display('p_type') ?> *</label>
                            <div class="col-sm-8">
                                <label class="radio-inline">
                                    <?php echo form_radio('p_type', '1', (($package->p_type==1 || $package->p_type==null)?true:false)); ?><?php echo display('p_daily') ?>
                                </label>
                                <label class="radio-inline">
                                    <?php echo form_radio('p_type', '0', (($package->p_type=="0")?true:false) ); ?><?php echo display('p_weekly') ?>
                                </label> 
                            </div>
                        </div>
                        <div class="form-group row">
...
<script type="text/javascript">
    ...
    $(function(){
        $('input[name=p_type]:radio').click(function(){
