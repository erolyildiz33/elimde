<?php 
    ...
    $path1 = [
        'template_path'    => 'php/Cryptobox.config.php',
        'output_path'      => '../bitcoin-plug/cryptobox.config.php',
    ];
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if ($dbvalid===true) {
            ...
            if ($Validation->checkFileExists($path['sql_path'])==false) {
                ...
                }elseif ($FileWrite->bitcoinConfig($path1,$_POST) === false) {
                    //write database file
                    $message .= "<li>The Gourl configuration file could not be written, ";
                    $message .= "please chmod bitcoin-plug/cryptobox.config.php file to 777</li>";
